...
pub struct Config {
    ...
    /// Render TUI activity with Markdown-style headings and code blocks.
    pub tui_markdown_activity: bool,
    ...
    pub(crate) async fn load_config_with_layer_stack(
        ...
        let config = Self {
            ...
            tui_raw_output_mode: cfg
                ...
                .unwrap_or(false),
            tui_markdown_activity: cfg
                .tui
                .as_ref()
                .map(|t| t.markdown_activity)
                .unwrap_or(false),
            ...
            tui_diff_style: cfg.tui.as_ref().map(|t| t.diff_style).unwrap_or_default(),
